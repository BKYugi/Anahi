...
namespace FT
{
    public class SaveFileDataWriter
    {
        ...
        // BEFORE WE CREATE A NEW SAVE FILE, WE MUST CHECK TO SEE IF ONE OF THIS CHARACTER SLOT ALREADY EXISTS (MAX 10 SLOTS)
        ...
        public void CreateNewCharacterSaveFile(CharacterSaveData characterData)
        {
            ...
            try
            {
                // CREATE THE DIRECTORY THE FILE WILL BE WRITTEN, IF DOES NOT EXIST
        ...
        public CharacterSaveData LoadSaveFile()
        {
            ...
            if (File.Exists(loadPath))
            {
                ...
                {
                    Debug.LogError("ERROR WHILST TRYING TO LOAD CHARACTER DATA, GAME NOT SAVED" + loadPath + "\n" + ex);
